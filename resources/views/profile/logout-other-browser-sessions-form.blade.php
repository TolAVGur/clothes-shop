<x-jet-action-section>
    ...
    <x-slot name="description">
        ...
        {{ __('Керуйте своїми активними сеансами та виходьте з них в інших браузерах і пристроях.') }}
    </x-slot>

    <x-slot name="content">
        <div class="max-w-xl text-sm text-gray-600">
            {{-- __('If necessary, you may log out of all of your other browser sessions across all of your devices. Some of your recent sessions are listed below; however, this list may not be exhaustive. If you feel your account has been compromised, you should also update your password.') --}}
            {{ __('За потреби ви можете вийти з усіх інших сеансів браузера на всіх своїх пристроях. Нижче наведено деякі з ваших останніх сеансів; однак цей список не може бути вичерпним. Якщо ви відчуваєте, що ваш обліковий запис зламано, вам також слід оновити свій пароль.') }}
        </div>
        ...
        <div class="flex items-center mt-5">
            <x-jet-button wire:click="confirmLogout" wire:loading.attr="disabled">
                ...
                {{ __('Вийти з інших сеансів браузера') }}
            </x-jet-button>
        ...
        <x-jet-dialog-modal wire:model="confirmingLogout">
            ...
            <x-slot name="content">
                ...
                {{ __('Будь ласка, введіть свій пароль, щоб підтвердити, що ви хочете вийти з інших сеансів браузера на всіх інших пристроях') }}
